...
# Etiqueta titulo.
# Primero donde se ubica, que contiene y el color.
...
# Listas de productos
lista_comidas = ['Pollo', 'Salmon', 'Bondiola', 'Entraña', 'Merluza', 'Veggie', 'Bife de Chorizo', 'Pizza']
lista_bebidas = ['Agua', 'Soda', 'Coca-cola', 'Vino', 'Cerveza', 'Fernet', 'Champagne', 'Jugo']
lista_postres = ['Flan', 'Helado', 'Brownie', 'Galletitas', 'Frutas', 'Mousse', 'Pastel', 'Tiramissu']
...
panel_calculadora.grid_rowconfigure(0, weight=1)
